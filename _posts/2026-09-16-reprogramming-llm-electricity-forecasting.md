...
This work was created with an even blend of human and AI contributions. AI was used to make stylistic edits, such as changes to structure, wording, and clarity. AI was used to make new content, such as text, images, analysis, and ideas. AI was prompted for its contributions, or AI assistance was enabled. AI-generated content was reviewed and approved. The following model or application was used: Claude Sonnet 5, Anthropic. The new content, specifically: flagging that none of the from-scratch baselines got their own hyperparameter search, they all inherited LoadCast's own learning rate and schedule, tuned for its frozen-backbone-plus-LoRA setup, not for an LSTM, a CNN, or a Transformer trained fully from scratch. That observation came from the AI, not from me. One disclaimer beyond what this badge covers: I reviewed the design, the results, and the writing throughout. The underlying code is the one place I'm relying on trust rather than my own line-by-line check. Statement generated with the [AI Attribution Toolkit](https://aiattribution.github.io/create-attribution).
